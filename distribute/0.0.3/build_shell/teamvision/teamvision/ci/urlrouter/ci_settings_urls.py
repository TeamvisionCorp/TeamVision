...
from teamvision.ci.views.ci_settings_view import settings_agent,settings_global_variable,credential_edit_page,credential_edit
from teamvision.ci.views.ci_settings_view import  settings_credentials,credential_create,credential_delete
from teamvision.ci.views.ci_settings_view import  server_edit_page,server_delete,settings_server,server_create,server_edit
from teamvision.ci.views import ci_settings_view
