...
from teamvision.administrate.views.admin_device_view import all,device_create_get,device_create_post,device_edit_get,device_edit_post,get_version_controll

from teamvision.administrate.views.admin_device_view import borrow_device,lend_device,return_device,get_devcie_confirm_dialog,device_delete
admin_device_router=[
