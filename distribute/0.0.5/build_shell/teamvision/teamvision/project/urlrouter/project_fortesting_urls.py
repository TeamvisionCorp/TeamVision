...
from teamvision.project.views.project_fortesting_view import all,edit,edit_page,get_create_dialog,create,download
from teamvision.project.views import project_fortesting_view
