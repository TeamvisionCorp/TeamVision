...
from teamvision.project.views.project_settings_view import basic,member,get_create_dialog,create,edit,delete,check_value_exists
from teamvision.project.views import project_settings_view
