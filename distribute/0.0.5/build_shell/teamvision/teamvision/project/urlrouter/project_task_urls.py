...
from teamvision.project.views import project_task_view
from teamvision.project.views.project_task_view import index_list,edit,get_create_dialog,create,delete,update_property,more_tasks
