...
class TempFileMongoFile(MongoFile):
    HOST = MONGODB['temp_file']['HOST']
    PORT = MONGODB['temp_file']['PORT']
    DB = MONGODB['temp_file']['DB']
    objects = MongoFileManager(HOST, PORT, DB, "temp_file")
...
class ProjectDocumentMongoFile(MongoFile):
    HOST = MONGODB['project_documents']['HOST']
    PORT = MONGODB['project_documents']['PORT']
    DB = MONGODB['project_documents']['DB']
    objects = MongoFileManager(HOST, PORT, DB, "project_file")

class ProjectExcelDocumentMongoFile(MongoFile):
    HOST = MONGODB['project_documents']['HOST']
    PORT = MONGODB['project_documents']['PORT']
    DB = MONGODB['project_documents']['DB']
    objects = MongoFileManager(HOST, PORT, DB, "project_excel")
