...
class TagOwner(ProjectModel):
    '''
    OwnerType: 1 通用,2 ci,3 agent,4 提测,5 需求
    '''
    Owner = models.IntegerField()
...
class ProjectIssue(ProjectModel):
    ...
    Desc = models.CharField(max_length=10000, null=True, default=issue_desc_default, verbose_name="问题描述")
    ...
    Priority = models.IntegerField(verbose_name="问题优先级")
