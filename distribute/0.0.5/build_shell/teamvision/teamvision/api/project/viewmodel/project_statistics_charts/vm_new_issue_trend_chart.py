...
class NewIssueTrendChart(VM_HighChart):
    '''
    classdocs
    '''
    def __init__(self,project_id,version_id,date_range=30):
        ...
        Constructor
        '''
        VM_HighChart.__init__(NewIssueTrendChart,project_id, version_id)
        self.chart_id=1
        self.chart_type="spline"
        self.chart_title="新增及解决问题趋势"
        self.chart_sub_title="每日趋势"
    ...
    def chart_xaxis(self):
        result=list()
        last30_days_data=IssueStatisticsService.issue_trend_last30days(self.project_id,self.version_id,self.date_range)
