...
class VM_AutoAPITestingPlugin(VM_CIPlugin):
    '''
    classdocs
    '''
    ...
    def __init__(self,plugin_parameter_dict):
        VM_CIPlugin.__init__(VM_AutoAPITestingPlugin,plugin_parameter_dict)
        self.plugin=CITaskPlugin.objects.get(VM_AutoAPITestingPlugin.plugin_id)
    ...
    def get_template_path(self):
        return CIPluginPath.auto_apitesting
