...
from teamvision.ci.views.ci_service_view import index,create,config,config_post,upload_file,download_file
from teamvision.ci.views import ci_service_view
