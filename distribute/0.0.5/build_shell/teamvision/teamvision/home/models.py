...
class Agent(HomeModel):
    ...
    AgentPort=models.IntegerField(default=0)
...
class DicType(models.Model):
    ...
    DicTypeLabel = models.CharField(max_length=50)
...
class FileInfo(HomeModel):
    ...
    FileFolder=models.IntegerField(null=True)
