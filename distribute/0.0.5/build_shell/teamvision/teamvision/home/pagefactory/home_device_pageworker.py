...
from teamvision.home.pagefactory.home_template_path import DevicePagePath
...
class HomeDevicePageWorker(DevicePageWorker):
    '''
    项目页面生成器
    '''
    ...
    def get_device_fullpage(self,request):
        ...
        pagefileds={'left_nav_bar':left_nav_bar,"device_list":device_list}
