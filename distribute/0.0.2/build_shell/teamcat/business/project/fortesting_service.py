...
@author: zhangtiande
'''
from doraemon.project.models import TestApplication, Project, Version, WebHook, ProjectModule, ProjectCodeUrl
from doraemon.project.mongo_models import FortestingMongoFile
...
class ForTestingService(BusinessService):
    ...
    def save_to_mongo(file):
        result = 0
        upload_file = file
        if ForTestingService.validate_upload_file(upload_file, 10 * 1024 * 1024, None):
