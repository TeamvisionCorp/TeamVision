...
from doraemon.user_center.views.ucenter_account_view import basic,password,upload_avatar,avatar,avatar_file,update_avatar,update_user_info,change_password
