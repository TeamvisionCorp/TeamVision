...
from doraemon.ci.viewmodels.ci_task_property_nav_bar import CITestingTaskPropertyNavBar
from doraemon.ci.pagefactory.ci_template_path import CITaskPath,TestingTaskPath
from doraemon.ci.models import CITask,AutoTestingTaskResult,AutoCaseResult,UnitTestCaseResult
...
from doraemon.ci.viewmodels.vm_auto_case_result import VM_AutoCaseResult
