...
from doraemon.ci.views.ci_task_view import create_dialog,task_config_basic,save_task_config,stop_task,download_package
from doraemon.ci.views.ci_task_view import create,update_property,get_task_config,copy,get_task_list,delete_task,start_task
