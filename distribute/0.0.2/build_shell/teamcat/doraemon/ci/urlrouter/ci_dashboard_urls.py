...
from doraemon.ci.views.ci_dashboard_view import index_list,get_build_log_dialog,add_message
from doraemon.ci.views import ci_dashboard_view,ci_task_view
