...
from doraemon.automationtesting.views.automationtaskview import get_list,init_autotask_formcontrol,get_autotask_page_counts,get_autotask_namelist
from doraemon.automationtesting.views.automationtaskview import copy_autotask,delete_autotask,check_name_exits,start_task,stop_task
