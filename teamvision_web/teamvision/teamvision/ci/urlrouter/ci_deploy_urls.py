...
from teamvision.ci.views.ci_deploy_view import index_list,config_task,task_history,task_parameter,build_with_parameter_page
from teamvision.ci.views import ci_deploy_view
