...
from teamvision.ci.models import CITask, CIDeployService
from teamvision.ci.viewmodels.plugins.vm_ci_scm_git import VM_GitPlugin
from teamvision.ci.viewmodels.plugins.vm_ci_scm_svn import VM_SvnPlugin
from teamvision.ci.viewmodels.plugins.vm_ci_shell_command import VM_ShellCommandPlugin
from teamvision.ci.viewmodels.plugins.vm_ci_shell_build import VM_ShellCommandBuildPlugin
from teamvision.ci.viewmodels.plugins.vm_ci_gradle_build import VM_GradleBuildPlugin
from teamvision.ci.viewmodels.plugins.vm_ci_ant_build import VM_AntBuildPlugin
from teamvision.ci.viewmodels.plugins.vm_ci_ios_build import VM_IOSBuildPlugin
from teamvision.ci.viewmodels.plugins.vm_ci_ios_command_build import VM_IOSCommandBuildPlugin
from teamvision.ci.viewmodels.plugins.vm_ci_service_replace import VM_ServiceReplacePlugin
from teamvision.ci.viewmodels.plugins.vm_ci_deploy_service import VM_DeployServicePlugin
from teamvision.ci.viewmodels.plugins.vm_ci_copy_file2server import VM_Copy2ServerPlugin
from teamvision.ci.viewmodels.plugins.vm_auto_apitesting import VM_AutoAPITestingPlugin
from teamvision.ci.viewmodels.plugins.vm_ci_xcode_settings_check import VM_XCodeSettingCheckPlugin
from teamvision.ci.viewmodels.plugins.vm_ci_xctest import VM_XCTestPlugin
from teamvision.ci.viewmodels.plugins.vm_auto_webui_testing import VM_AutoWebUITestingPlugin
