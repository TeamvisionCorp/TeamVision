...
from teamvision.ci.mongo_models import CIServiceMongoFile
from business.common.mongodb_service import MongoDBService
from teamvision.home.models import FileInfo
from teamvision.ci.mongo_models import DeployServiceReplaceConfig,ReplaceFileMap
...
class CIService(BusinessService):
    ...
    def delete_service_file(request,file_id):
        ...
        CIServiceMongoFile.objects.delete_attachment(file_info.FilePath)
